...
<template>
    <header>
        <nav class="navbar navbar-expand-lg colore  ">
            <img src="./assets/images (1)/logo.png" alt="">
            <div class="collapse navbar-collapse" id="navbarNavDropdown"
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="#"><img src="./assets/images (1)/icon/cart-icon.png" alt=""></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="#"><img class="logo"
                                src="./assets/hover-20231211T144941Z-001/hover/btn.JPG" alt=""></a>
                    </li>
                </ul>
            </div>
